...
@Component({
  selector: 'app-hospital-call-record',
  templateUrl: './hospital-call-record.component.html',
  styleUrls: ['./hospital-call-record.component.scss'],
})
export class HospitalCallRecordComponent  {
  isCollapsed = false;
