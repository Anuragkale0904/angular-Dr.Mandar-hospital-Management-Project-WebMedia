...
@Component({
  selector: 'app-target-doctor',
  templateUrl: './target-doctor.component.html',
  styleUrls: ['./target-doctor.component.scss'],
})
export class TargetDoctorComponent  {
