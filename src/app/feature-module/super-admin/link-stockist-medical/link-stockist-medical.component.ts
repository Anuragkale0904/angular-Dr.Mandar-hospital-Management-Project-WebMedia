...
@Component({
  selector: 'app-link-stockist-medical',
  templateUrl: './link-stockist-medical.component.html',
  styleUrl: './link-stockist-medical.component.scss',
})
export class LinkStockistMedicalComponent {
