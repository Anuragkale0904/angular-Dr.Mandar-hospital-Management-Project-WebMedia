...
export class routes {
  ...
  static PromoterSales: any;
  static Promoter: any;
  static UserRoleComponent: any;
  ...
  public static get addcompany(): string {
    return this.application + '/addcompany';
  }
  public static get doctorvisit(): string {
    return this.application + '/doctor-visit';
  }
  public static get addheadquater(): string {
    return this.application + '/add-headquater';
  }
  public static get adduser(): string {
    return this.application + '/adduser';
  }

  public static get addproduct(): string {
    return this.application + '/addproduct';
  }
  public static get addmanager(): string {
    return this.application + '/add-manager';
  }

  public static get userrole(): string {
    return this.application + '/user-role';
  }

  public static get userlogs(): string {
    return this.application + '/user-logs';
  }
  public static get addmr(): string {
    return this.application + '/add-mr';
  }
  public static get allowance(): string {
    return this.application + '/allowance';
  }
  public static get expensehead(): string {
    return this.application + '/expense-head';
  }

  public static get mediagallery(): string {
    return this.application + '/media-gallery';
  }
  public static get employeelist(): string {
    return this.application + '/employee-list';
  }

  public static get city(): string {
    return this.application + '/add-city';
  }
  public static get AddStockist(): string {
    return this.application + '/AddStockist';
  } 

  public static get AddZone(): string {
    return this.application + '/add-zone';
  } 
  public static get calenderholiday(): string {
    return this.application + '/calender-holiday';
  } 
  public static get leavecalender(): string {
    return this.application + '/leave-calender';
  } 
  public static get presentation(): string {
    return this.application + '/presentation';
  } 

  public static get addmedical(): string {
    return this.application + '/add-medical';
  }
  public static get year(): string {
    return this.application + '/year';
  }
  public static get tds(): string {
    return this.application + '/tds';
  }
  

  public static get addmarketing(): string {
    return this.application + '/add-marketing';
  }

  public static get adddoctor(): string {
    return this.application + '/add-doctor';
  }
  public static get secondarysales(): string {
    return this.application + '/secondary-sales';
  }

  public static get doctorlist(): string {
    return this.application + '/doctor-list';
  }
  public static get target(): string {
    return this.application + '/target';
  }
  public static get targethq(): string {
    return this.application + '/target-hq';
  }
  public static get targetdoctor(): string {
    return this.application + '/target-doctor';
  }
  public static get targetproduct(): string {
    return this.application + '/target-product';
  }
  public static get Report(): string {
    return this.application + '/report';
  }
  public static get firmsvisit(): string {
    return this.application + '/firms-visit';
  }
  public static get defaultotp(): string {
    return this.application + '/default-otp';
  }
  ...
  public static get callrecord(): string {
    return this.expenses + '/call-record';
  }
  public static get hospitalcallrecord(): string {
    return this.expenses + '/hospital-call-record';
  }
  ...
  public static get medicinemaster(): string {
    return this.baseUrl + '/super-admin/medicine-master';
  }
  ...
  public static get domainRequest(): string {
    return this.baseUrl + '/super-admin/promotor-sales';
  }
  ...
  public static get LinkStockistMedicalComponent(): string {
    return this.baseUrl + '/super-admin/link-stockist-medical';
  }
