...
export class ToasterService {
  ...
  typeSuccess(message: string, tittle?: string) {
    this.toaster.success(message, tittle || 'Dr.Mandar', {
      timeOut: 1000,
      progressBar: true,
  ...
  typeInfo(message: string, tittle?: string) {
    this.toaster.info(message, tittle || 'Dr.Mandar', {
      timeOut: 1000,
      progressBar: true,
      progressAnimation: 'increasing',
      positionClass: 'toast-top-right',
  ...
  typeWarning(message: string, tittle?: string) {
    this.toaster.warning(message, tittle || 'Dr.Mandar', {
      timeOut: 1000,
      progressBar: true,
      progressAnimation: 'increasing',
      positionClass: 'toast-top-right',
  ...
  typeError(message: string, tittle?: string) {
    this.toaster.error(message, tittle || 'Dr.Mandar', {
      timeOut: 1000,
      progressBar: true,
      progressAnimation: 'increasing',
      positionClass: 'toast-top-right',
